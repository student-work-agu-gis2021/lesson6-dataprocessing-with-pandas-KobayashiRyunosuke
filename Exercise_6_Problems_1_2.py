...
# YOUR CODE HERE 8
avg_temp_1969 = data.query('19690501 <= DATA <=19690831')['TMAX'].mean()
#CAUTION!!! DON'T EDIT THIS PART START
...
# YOUR CODE HERE 9
def fahr_to_celcius(temp_faphrenheit):
  converted_temp = (temp_faphrenheit - 32)/1.8
  return converted_temp

data['TAVG_C'] = data['TAVG'].apply(fahr_to_celcius)
